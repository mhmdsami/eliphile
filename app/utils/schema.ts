...
export const signUpFieldsSchema = z.object({
  username: z.string().min(3, "Username must be at least three characters long").max(50),
...
export const imageUploadSchema = z.object({
  ...
  title: z.string().min(3, "Title must be at least three characters long").max(50),
